...
draw_line(complex(math.cos(math.pi/4), math.sin(math.pi/4)), complex(math.cos(math.pi+math.pi/4), math.sin(math.pi+math.pi/4)), fill='grey', stroke_width=stroke_width)
draw_line(complex(math.cos(3*math.pi/4), math.sin(3*math.pi/4)), complex(math.cos(math.pi+3*math.pi/4), math.sin(math.pi+3*math.pi/4)), fill='grey', stroke_width=stroke_width)


d.draw(euclid.shapes.Circle(0, 0, 1), stroke='black', stroke_width=stroke_width, fill='none')

d.setRenderSize(w=400)
d.saveSvg('escherOverlay_limit2_test1.svg')
d.savePng('escherOverlay_limit2_test1.png')